package com.divine.generator.service;
...
import com.divine.generator.mapper.GenTableColumnMapper;
import com.divine.generator.util.GenUtils;
import com.divine.generator.util.VelocityInitializer;
import com.divine.generator.util.VelocityUtils;
...
public class GenTableServiceImpl implements IGenTableService {
    ...
    @Override
    public PageInfoRes<GenTable> selectPageGenTableList(GenTable genTable, BasePage basePage) {
        Page<GenTable> page = baseMapper.selectPage(basePage.build(), this.buildGenTableQueryWrapper(genTable));
    ...
    @Override
    public PageInfoRes<GenTable> selectPageDbTableList(GenTable genTable, BasePage basePage) {
        Page<GenTable> page = baseMapper.selectPageDbTableList(basePage.build(), genTable);
        return PageInfoRes.build(page);
    }
