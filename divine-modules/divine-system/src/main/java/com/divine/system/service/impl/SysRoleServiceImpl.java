...
import com.divine.system.mapper.SysRoleDeptMapper;
import com.divine.system.mapper.SysRoleMapper;
import com.divine.system.mapper.SysRoleMenuMapper;
import com.divine.system.mapper.SysUserRoleMapper;
...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    @Override
    public PageInfoRes<SysRoleVo> selectPageRoleList(SysRoleDto role, BasePage basePage) {
        Page<SysRoleVo> page = roleMapper.selectPageRoleList(basePage.build(), this.buildQueryWrapper(role));
    ...
    public List<SysRoleVo> selectRoleAll() {
        return this.selectRoleList(new SysRoleDto());
    }
